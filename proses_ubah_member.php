    ...
    if(empty($nama_member)){
        ...
        if(empty($telp)){
            ...
            if($update){
               ...
               echo "<script>alert('Succes update member');location.href='tampil_member.php';</script>";

            } else {

               echo "<script>alert('Fail update member');location.href='ubah_member.php?id_member=".$id."';</script>";
