...
<body>
    <?php
        include 'koneksi.php';
        $sql = "select transaksi.*, paket.nama_paket, paket.harga, user.nama_user as nama_user, member.nama_member as nama_member,member.alamat, member.telp, detail_transaksi.qty
                from transaksi
    ...
    ?>
		...
		<article>
			...
			<table class="inventory">
				...
				<tbody>
					<tr>
						<td><a class="cut">-</a><span ><?php echo $data['nama_paket']; ?></span></td>
